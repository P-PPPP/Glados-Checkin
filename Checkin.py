...
def Checkin(Cookie:str)->dict:
    return  requests.post("https://glados.rocks/api/user/checkin",headers={"User-Agent":"Mozilla/5.0","Cookie":Cookie,"Origin":"https://glados.rocks"},data={"token":"glados.network"}).json()
